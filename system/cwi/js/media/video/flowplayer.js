         ...
         */
            ...
            if (!root.data('flowplayer')) { // Only bind once
                ...
                root.bind("boot", function () {
                    ...
                    // no engine
                    if (!api.engine) return api.trigger("error", {
...
//de_(root[0]);
    ...
    flowplayer(function (api, root) {
        ...
        root.addClass("flowplayer").append($insert_html.replace(/class='/g, 'class=\'fp-'));
    ...
    flowplayer(function (api, root) {
		...
		$insert_html =	"<div class='fp-help'>"+
						...
						"<p><em>&nbsp;. </em>seek to previous</p><p><em>1</em><em>2</em>&hellip;<em>6</em> seek to 10%, 20%, &hellip;60% </p>"+
						"</div>"+
						"</div>";

        // TODO: add to player-layout.html
        root.append($insert_html);
    ...
    flowplayer(function (player, root) {
        ...
        var conf = player.conf,
            ...
            target = $("<div/>", {
                ...
                .append("<label>"+$(root).attr("title")+" ("+$(root).attr("video_author")+")</label><div id='video_about'>"+$(root).attr("video_about")+"</div>").appendTo(ui),
        ...
        player.embedCode = function () {
            ...
            var scriptAttrs = {
                src: "//embed.flowplayer.org/5.4.1/embed.min.js"
            };
